...
object MathUtils {
  ...
  /**
   * Inverse linear interpolation: returns the interpolation factor t such that lerp(a, b, t) ==
   * value. Returns 0 if a == b.
   */
  ...
  /**
   * Smooth Hermite interpolation between 0 and 1 when [x] is in [edge0, edge1]. Returns 0 if x <=
   * edge0, 1 if x >= edge1.
   */
