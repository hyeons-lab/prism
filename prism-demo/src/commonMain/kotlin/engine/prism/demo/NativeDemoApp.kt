...
/**
 * Demo using native widgets directly without Compose.
 * This demonstrates how to integrate the engine into a platform's
 * native UI framework (Android XML, UIKit, SwiftUI, etc.)
 */
class NativeDemoApp {
    ...
    fun start(width: Int, height: Int) {
        ...
        scene.addNode(
            LightNode(
                ...
                transform = transform.copy(position = Vec3(3f, 5f, 3f))
            },
        )
