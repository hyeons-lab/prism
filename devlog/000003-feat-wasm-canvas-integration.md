...
- **[2026-02-15 00:00 PST]** `README.md` — Added wgpu4k pinned commit hash (`3fc6e327`, verified against local clone HEAD) to build instructions and tech stack table, updated Platform Support table (Web WASM/JS → In Progress), updated Milestone table (M6 → In Progress)
