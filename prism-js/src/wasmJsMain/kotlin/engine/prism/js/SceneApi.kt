...
@JsExport fun prismCreateScene(name: String): String = Registry.put(Scene(name))
...
@JsExport fun prismCreateNode(name: String): String = Registry.put(Node(name))

/** Creates a MeshNode and returns its handle. */
@JsExport fun prismCreateMeshNode(name: String): String = Registry.put(MeshNode(name))

/** Creates a CameraNode and returns its handle. */
@JsExport fun prismCreateCameraNode(name: String): String = Registry.put(CameraNode(name))

/** Creates a LightNode and returns its handle. */
@JsExport fun prismCreateLightNode(name: String): String = Registry.put(LightNode(name))
