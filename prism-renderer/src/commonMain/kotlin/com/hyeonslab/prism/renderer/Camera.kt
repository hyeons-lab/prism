 ...
 *
 * Supports both perspective and orthographic projection modes. Uses a right-handed coordinate
 * system consistent with the engine's math module.
 */
class Camera {
  ...
  fun projectionMatrix(): Mat4 {
    return if (isOrthographic) {
      ...
      Mat4.perspective(fovY = fovRadians, aspect = aspectRatio, near = nearPlane, far = farPlane)
    }
  }
  ...
  override fun toString(): String {
    ...
    return "Camera(pos=$position, target=$target, $mode, " +
