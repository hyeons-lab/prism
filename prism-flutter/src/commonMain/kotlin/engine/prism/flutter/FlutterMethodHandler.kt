...
/**
 * Handles Flutter MethodChannel calls by dispatching to PrismBridge.
 * Platform-specific implementations will connect this to the actual
 * Flutter MethodChannel or FFI.
 */
