...
/**
 * Bridge between the Prism engine and Flutter platform channels.
 * Provides a simplified API surface that Flutter's Dart code can call
 * through platform channels (MethodChannel) or FFI.
 */
class PrismBridge {
