...
tasks.register<Copy>("bundleFlutterDemoMacOS") {
  ...
  val xcfDir = layout.buildDirectory.dir("XCFrameworks/release/PrismFlutterDemo.xcframework")
  from(xcfDir)
...
tasks.register<Copy>("copyWasmToFlutterWeb") {
  ...
  from(
    project(":prism-flutter").layout.projectDirectory.file("flutter_plugin/lib/src/prism_loader.js")
  )
