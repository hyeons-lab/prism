 ...
 *
 * DemoMacosBridge.zoom() and orbitBy() are macOS platform code; the pure-math
 * portions are verified here via extracted helpers that mirror the production logic.
 */
class DemoInputTest {
